        ...
        <div className="bg-obscure-darker min-h-screen text-clarity-lighter font-sans">
            ...
            {!prod.product ? (
                <main className="flex flex-col items-center justify-center h-screen">
                    ...
                    <p className="text-clarity text-lg">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="mt-4 text-xs text-clarity text-center uppercase tracking-wider">
                                    {prod.product.isglobalshippingavailable ? "GLOBAL SHIPPING AVAILABLE." : "GLOBAL SHIPPING NOT AVAILABLE."}
                                    <br />
                                    {prod.product.warrantytime ? `${prod.product.warrantytime} WARRANTY INCLUDED.` : "NO WARRANTY INFORMATION."}
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div className="lg:col-span-2 bg-obscure p-8 border border-obscure-lightest flex flex-col justify-center min-h-50">
                                    <div className="text-emph-light text-2xl mb-4">
                                        ⚡
                                    </div>
                                    <h3 className="text-xl font-bold text-clarity-lighter uppercase mb-2">
                                        {prod.product.spec_title_1}
                                    </h3>
                                    <p className="text-clarity text-sm">
                                        {prod.product.spec_value_1}
                                    </p>
                                </div>
                                ...
                                <div className="bg-obscure p-8 border border-obscure-lightest flex flex-col justify-center min-h-50">
                                    ...
                                    <h3 className="text-sm font-bold text-clarity-lighter uppercase mb-2">
                                        {prod.product.spec_title_2}
                                    </h3>
                                    <p className="text-clarity text-xs">
                                        {prod.product.spec_value_2}
                                    </p>
                                </div>
                                ...
                                <div className="bg-obscure p-8 border border-obscure-lightest flex flex-col justify-center min-h-50">
                                    ...
                                    <h3 className="text-sm font-bold text-clarity-lighter uppercase mb-2">
                                        {prod.product.spec_title_3}
                                    </h3>
                                    <p className="text-clarity text-xs">
                                        {prod.product.spec_value_3}
                                    </p>
                                </div>
                                ...
                                <div className="lg:col-span-2 bg-obscure p-8 border border-obscure-lightest flex flex-col justify-center min-h-50">
                                    <div className="flex justify-between items-center mb-6">
                                        <div className="text-emph-light text-2xl">
                                            📈
                                        </div>
                                        <div className="text-right">
                                            <div className="text-3xl font-black text-emph-light">
                                                {prod.product.benchmark_score}%
                                            </div>
                                            <div className="text-[10px] text-clarity uppercase tracking-widest">
                                                {prod.product.benchmark_label}
                                              </div>
                                        </div>
                                    </div>
                                    <h3 className="text-lg font-bold text-clarity-lighter uppercase mb-4">
                                        PERFORMANCE METER
                                    </h3>
                                    <div className="w-full h-1 bg-obscure-lightest rounded-full overflow-hidden">
                                        <div className="h-full bg-emph-light" style={{ width: `${prod.product.benchmark_score}%` }}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                                <div>
                                    ...
                                    <p className="text-clarity text-sm">
                                        Verified intelligence from the front
                                        lines.
                                    </p>
                                </div>
                                <div className="text-right">
                                    ...
                                    <div className="text-xl font-bold text-clarity-lighter">
                                        PLACEHOLDER / 5.0
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                                {[1, 2, 3].map((i) => (
                                    <div
                                        key={i}
                                        className="bg-obscure border border-obscure-lightest p-8"
                                    >
                                        <div className="flex justify-between items-start mb-6">
                                            <div className="text-xs text-clarity uppercase tracking-wider">
                                                PLACEHOLDER / PRO USER
                                            </div>
                                            <div className="text-[10px] font-bold text-emph-light uppercase tracking-widest bg-emph-light/10 px-2 py-1 rounded">
                                                VERIFIED
                                            </div>
                                        </div>
                                        <p className="text-clarity-lighter text-sm italic leading-relaxed mb-6">
                                            "PLACEHOLDER review text. The
                                            latency difference is actually
                                            perceptible. Best typing experience
                                            of my career."
                                        </p>
