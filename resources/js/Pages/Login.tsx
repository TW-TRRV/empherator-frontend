  ...
  return (
    <div className="min-h-screen flex flex-col bg-obscure-darker font-sans text-clarity-lighter">
      ...
      <main className="flex-1 flex items-center justify-center relative w-full h-full my-32">
        ...
        {/* Login Card */}
        <div className="w-full max-w-md md:w-95 bg-obscure-lighter border border-obscure-lightest p-4 sm:p-10 flex flex-col items-center">
          ...
          <Link href="/" className="text-[9px] text-clarity-light hover:text-clarity-lighter uppercase tracking-widest border-b border-transparent hover:border-clarity-lighter transition-all duration-300">
