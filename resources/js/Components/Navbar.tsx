      ...
      <nav className="fixed z-50 top-0 bg-obscure-darker border-b border-obscure-lightest h-20 w-full px-4 md:px-8 lg:px-20">
        <div className="flex w-full h-full items-center justify-between md:justify-start relative">
          <div className="flex text-2xl items-center md:flex-1">
            ...
            <Link href="/" className="text-clarity-lighter md:ml-3 font-black">
              EMPHERATOR
            </Link>
          </div>
          ...
          <div className="flex items-center text-3xl text-clarity-light gap-4 md:flex-1 md:justify-end">
            ...
            <Link href="/cart" className="hover:text-emph-light transition-all duration-300 cursor-pointer">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="#" className="hover:text-emph-light transition-colors">Processors</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">Graphics Cards</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">Motherboards</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">Memory</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-sm font-bold text-clarity-light mb-4">Brands</h3>
              <ul className="space-y-3">
                <li><Link href="#" className="hover:text-emph-light transition-colors">Intel</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">AMD</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">NVIDIA</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">ASUS</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-sm font-bold text-clarity-light mb-4">Price Range</h3>
              <ul className="space-y-3">
                <li><Link href="#" className="hover:text-emph-light transition-colors">Under $100</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">$100 - $300</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">$300 - $600</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">Over $600</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-sm font-bold text-clarity-light mb-4">Ratings</h3>
              <ul className="space-y-3">
                <li><Link href="#" className="hover:text-emph-light transition-colors">4 Stars & Up</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">3 Stars & Up</Link></li>
                <li><Link href="#" className="hover:text-emph-light transition-colors">2 Stars & Up</Link></li>
              </ul>
            </div>
          </div>
        </div>
