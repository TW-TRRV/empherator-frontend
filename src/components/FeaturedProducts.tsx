      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 w-full">
          {products.map((product) => (
            ...
            >
              {/* Product Image */}
              <Link to="/product/placeholder" className="aspect-[4/3] w-full bg-obscure-darker overflow-hidden p-6 flex items-center justify-center">
                <img
                  src={product.image}
                  alt={product.name}
