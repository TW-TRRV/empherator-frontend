        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
            <div className="flex flex-wrap gap-2 md:gap-4">
              <Link to="/" className="px-6 py-2 bg-clarity-lighter text-obscure-darker text-xs font-bold tracking-widest cursor-pointer flex items-center justify-center">
                ALL
              </Link>
              <Link to="/" className="px-6 py-2 border border-obscure-lightest text-clarity-lighter text-xs font-bold tracking-widest hover:border-clarity-dark transition-colors cursor-pointer flex items-center justify-center">
                KEYBOARDS
              </Link>
              <Link to="/" className="px-6 py-2 border border-obscure-lightest text-clarity-lighter text-xs font-bold tracking-widest hover:border-clarity-dark transition-colors cursor-pointer flex items-center justify-center">
                MICE
